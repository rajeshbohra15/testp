...
final class FoodStore {
	...
	public function includes() {
		...
		include_once WFS_ABSPATH . 'includes/class-wfs-shipping.php';
		include_once WFS_ABSPATH . 'includes/class-wfs-order.php';
	...
	/**
     * Test if we're on Food Store's admin page
     *
     * @return bool
     */
  	public function is_plugin_page() {
    	...
    	$screen = get_current_screen();
		  ...
		  return ( $screen_id == 'toplevel_page_wfs-settings' ) ? true : false;
    }  
