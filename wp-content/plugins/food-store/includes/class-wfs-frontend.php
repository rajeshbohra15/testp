...
class WFS_Frontend {
   ...
   */
    ...
    add_action( 'foodstore_asap_block', array( $this, 'wfs_asap_block' ), 10 );
  }
  ...
  public function validate_cart_items() {
    ...
    $service_type = isset( $_COOKIE['service_type'] ) ? $_COOKIE['service_type'] : wfs_get_default_service_type();
  ...
  public function wfs_adding_custom_price( $cart ) {
    ...
    $cart_action = isset( $_POST['action'] ) ? sanitize_text_field( $_POST['action'] ) : '';
    ...
    foreach ( $cart->get_cart() as $key => $cart_item ) {
      ...
      //WOOCS compatibility. Snippet taken from their official url: https://currency-switcher.com/food-store-online-food-delivery-pickup/#/woot-gallery-woof
  ...
  public function wfs_asap_block( $service_type ) {
    wfs_get_template( 'services/asap-block.php', array(
