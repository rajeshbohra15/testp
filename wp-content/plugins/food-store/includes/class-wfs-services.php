...
class WFS_Services {
  ...
  public function woocommerce_form_field_checkout_asap_fields( $field, $key, $args, $value ) {
        ...
        $field = '<ul class="form-row nav-tabs nav checkout-asap-block wfs-schedule-nav-group" role="tablist">
    		            <li class="nav-item">
      			          <a class="nav-link active" data-toggle="tab" href="#'.$service_type.'_asap" role="tab" aria-controls="'.$service_type.'_asap" aria-selected="true" >'.$asap_label.'</a>
    			          </li>
    			          <li class="nav-item">
      			          <a class="nav-link" data-toggle="tab" href="#'.$service_type.'_schedule" role="tab" aria-controls="'.$service_type.'_schedule" aria-selected="false">'.$order_later_label.'</a>
    			          </li>
  			          </ul>
        ';
			}
