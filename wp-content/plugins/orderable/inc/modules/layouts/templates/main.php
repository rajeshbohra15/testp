...
<div class="orderable-main <?php echo esc_attr( apply_filters( 'orderable_main_class', '', $args ) ); ?>">
	...
	<div class="orderable-main__sections">
		<?php foreach ( $products as $product_group ) { ?>
			...
			<?php if ( empty( $product_group['products'] ) && ! $has_child_categories ) {
				continue;
			} ?>

			<div id="category-<?php echo esc_attr( is_array( $category ) ? $category['slug'] : 'uncategorized' ); ?>" class="orderable-main__group">
