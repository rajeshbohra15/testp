...
<div class="<?php echo esc_attr( implode( ' ', $class ) ); ?>"
     ...
     <?php } ?>
>
	<?php include Orderable_Helpers::get_template_path( 'templates/product/hero.php' ); ?>
	<div class="orderable-product__content-wrap">
		<?php include Orderable_Helpers::get_template_path( 'templates/product/card-content.php' ); ?>
		<?php include Orderable_Helpers::get_template_path(  'templates/product/actions.php' ); ?>
	</div>
</div>
