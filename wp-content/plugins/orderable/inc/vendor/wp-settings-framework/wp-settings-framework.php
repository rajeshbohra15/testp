...
if ( ! class_exists( 'Orderable_Settings_Framework' ) ) {
	/**
	 * Orderable_Settings_Framework class
	 */
	class Orderable_Settings_Framework {
		/**
		 * Settings wrapper.
		 *
		 * @var array
		...
		/**
		 * Orderable_Settings_Framework constructor.
		 *
