...
== Changelog ==
== 1.2.9.3 - January 11, 2022
*	Fix: Admin settings tab validation issue

== 1.2.9.2 - May 4, 2021
*	Fix: Business Hours - Structured data issue due to missing "image" markup
*	Fix: Deprecated jQuery functions

= 1.2.9.1 - November 16, 2020 =
*	Enhancement: Heading - Added unit field for separator width
*	Fix: Breadcrumbs - Added alpha channels and reset options in color controls
*	Fix: Breadcrumbs - Minor CSS issue
*	Fix: Info Box - Minor CSS issue
*	Fix: Info List - z-index issue
*	Fix: Contact Form 7 - typography were not working for "label" tag

= 1.2.9 - May 11, 2020 =
*	New: Added Breadcrumbs module
