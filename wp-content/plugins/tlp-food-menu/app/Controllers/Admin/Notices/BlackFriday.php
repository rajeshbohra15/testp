...
class BlackFriday {
	...
	public function bf_notice() {
		if ( get_option( 'rtfm_bf_2022' ) != '1' ) {
			if ( ! isset( $GLOBALS['rt_bf_2021_notice'] ) ) {
				$GLOBALS['rt_bf_2021_notice'] = 'rtfm_bf_2022';
				self::notice();
			}
		}
	}
	...
	private static function notice() {
		...
		add_action(
			...
			function () {
				...
				?>
			<div class="notice notice-info is-dismissible" data-rtfmdismissable="rtfm_bf_2022" style="display:grid;grid-template-columns: 100px auto;padding-top: 25px; padding-bottom: 22px;">
				...
				<p style="margin:0 0 2px;">Don't miss out on our biggest sale of the year! Get your
					<b><?php echo esc_html( $plugin_name ); ?> plan</b> with <b>UP TO 50% OFF</b>! Limited time offer expires on
					December 2.
				</p>
				<p style="margin:0;">
