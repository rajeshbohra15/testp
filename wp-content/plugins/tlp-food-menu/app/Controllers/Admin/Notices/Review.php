...
class Review {
	...
	public static function display_admin_notice() {
		...
		if ( ! in_array( $pagenow, $exclude ) ) {
			$dont_disturb = add_query_arg( 'rtfm_spare_me', '1', self::current_admin_url() );
			$remind_me    = add_query_arg( 'rtfm_remind_me', '1', self::current_admin_url() );
			$rated        = add_query_arg( 'rtfm_rated', '1', self::current_admin_url() );
