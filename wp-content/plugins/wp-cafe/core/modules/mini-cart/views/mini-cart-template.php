						...
						<?php 
							...
							?>
								<?php if ( wc_coupons_enabled() ) { ?>
									<label id="promo-code" class="showcoupon wpc-minicart-copoun-label" for="coupon-code">
										<?php esc_html_e('Have a coupon code?', 'wpcafe'); ?>
									</label>
								...
								<?php } else { ?>
									...
									<?php } ?>
										...
										<button type="submit" id="minicart-apply-button" class="wpc-cupon-btn button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'wpcafe' ); ?>"><?php esc_attr_e( 'Apply', 'wpcafe' ); ?></button>
